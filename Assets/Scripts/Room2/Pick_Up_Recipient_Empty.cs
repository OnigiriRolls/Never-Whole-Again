...
public class Pick_Up_Recipient_Empty : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        ...
        if (GlobalManager.Instance.R2_wd_trigger == true )
        {
            ...
            for (int i = 0; i < inventory.slots.Length; i++)
            {
                ...
                {
                    GlobalManager.Instance.R3_Recipient_Index = i;
                    trans.full[i] = true;
                    ...
                    GlobalManager.Instance.Recipient_empty = true;
