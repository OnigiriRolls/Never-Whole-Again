...
public class Pick_Up_UI_Screwdriver : MonoBehaviour
{
    ...
    public void Pick_Up()
    {
        for (int i = 0; i < inventory.slots.Length; i++)
        {
            if (inventory.isfull[i] == false)
            {
                ...
                //o punem in inventar
                GlobalManager.Instance.vaultState = true;
                GlobalManager.Instance.screwdriver_taken = true;
                GlobalManager.Instance.screwdriver_index = i;
